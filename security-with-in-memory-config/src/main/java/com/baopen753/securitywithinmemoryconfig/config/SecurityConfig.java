package com.baopen753.securitywithinmemoryconfig.config;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user1 = User.withUsername("baopen753").password("{noop}baopen753").authorities("READ").roles("USER").build();
        UserDetails user2 = User.withUsername("baokun753").password("{bcrypt}$2a$12$qFZsYy8Zf11qLvUQmsoMmuKf681/k8MoM3a18RqK6Yd3iIbTAgUjm").authorities("ADMIN").roles("ADMIN").build();
